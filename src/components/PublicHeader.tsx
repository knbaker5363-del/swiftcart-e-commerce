        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <Link to="/favorites">
            <Button variant="ghost" size="icon" className="relative">
              ...
              {favoritesCount > 0 && <Badge className="absolute -right-2 -top-2 h-5 w-5 rounded-full p-0 flex items-center justify-center text-xs bg-red-500 hover:bg-red-600">
                  {favoritesCount}
                </Badge>}
            </Button>
          </Link>
          <Button variant="outline" size="icon" className="relative" onClick={onCartOpen}>
            ...
            {itemCount > 0 && <Badge variant="destructive" className="absolute -right-2 -top-2 h-5 w-5 rounded-full p-0 flex items-center justify-center text-xs">
                {itemCount}
              </Badge>}
          </Button>
        </div>
